...
static char *fulluseragent =
    ...
    "Chrome/88.0.4324.152 Safari/537.36"; /* Or override the whole user agent
                                             string */
...
static Key keys[] = {
    ...
    {MODKEY, GDK_KEY_d, stop, {0}},

    {MODKEY | GDK_SHIFT_MASK, GDK_KEY_r, reload, {.i = 1}},
    {MODKEY, GDK_KEY_r, reload, {.i = 0}},

    {MODKEY, GDK_KEY_s, navigate, {.i = +1}},
    {MODKEY, GDK_KEY_h, navigate, {.i = -1}},
    {MODKEY, GDK_KEY_w, playexternal, {0}},

    /* vertical and horizontal scrolling, in viewport percentage */
    {MODKEY, GDK_KEY_n, scrollv, {.i = +10}},
    {MODKEY, GDK_KEY_t, scrollv, {.i = -10}},
...
#define HOMEPAGE "https://twitter.com"
