...
/* package random-number-0.1.0.0 */
#ifndef VERSION_random_number
#define VERSION_random_number "0.1.0.0"
#endif /* VERSION_random_number */
#ifndef MIN_VERSION_random_number
#define MIN_VERSION_random_number(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_random_number */
...
#define CURRENT_COMPONENT_ID "random-number-0.1.0.0-inplace-random-number"
